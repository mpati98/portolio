      ...
      <RevealOnScroll>
        ...
        <div className="text-center z-10 px-4">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            ...
            labore debitis dolore cupiditate aperiam sapiente aliquam, odio
            praesentium nemo fugit rem expedita quia asperiores provident ipsum
            voluptate ut pariatur nesciunt.
          </p>
