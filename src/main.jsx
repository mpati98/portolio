...
import { SanPhamKhac } from "./components/pages/SanPhamKhac.jsx";
...
const DangKyLopHocMienPhi = ["Làm thế nào để đăng ký học?"];
const continueMenu = ["Tìm hiểu thêm", "Đăng ký lớp học"];
...
const flow = {
  ...
  unknown_input: {
    message:
      "Xin lỗi, điều bạn yêu cầu chưa được hỗ trợ, chúng tôi sẽ cập nhật trong thời gian tới, thay vào đó hãy bắt đầu bằng:",
    options: startOption,
    path: "process_options",
  },
  process_options: {
  ...
  "Kiến thức chung về golf": {
    message:
      "Golf là một môn thể thao mà người chơi sử dụng nhiều loại gậy khác nhau để đánh một quả bóng nhỏ vào một loạt các lỗ trên sân trong số lần đánh ít nhất có thể.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Sân golf có bao nhiêu lỗ?": {
    message:
      "Một sân golf tiêu chuẩn thường có 18 lỗ. Tuy nhiên, cũng có những sân 9 lỗ hoặc 36 lỗ.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Par trong golf là gì?": {
    message:
      "'Par' là số gậy tiêu chuẩn mà một golfer chuyên nghiệp được kỳ vọng sẽ hoàn thành một lỗ hoặc toàn bộ vòng golf. Mỗi lỗ sẽ có par 3, par 4 hoặc par 5 tùy thuộc vào độ dài của nó.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Điểm số trong golf được tính như thế nào?": {
    message:
      "- **Ace (Hole-in-one):** Đánh bóng vào lỗ chỉ bằng một cú đánh duy nhất.\n- **Eagle:** Dưới par 2 gậy ở một lỗ.\n- **Birdie:** Dưới par 1 gậy ở một lỗ.\n- **Par:** Bằng số gậy tiêu chuẩn.\n- **Bogey:** Vượt par 1 gậy ở một lỗ.\n- **Double Bogey:** Vượt par 2 gậy ở một lỗ.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Cần chuẩn bị gì khi ra sân golf?": {
    message:
      "Bạn sẽ cần một bộ gậy golf (tối đa 14 gậy), bóng golf, tee (dụng cụ đặt bóng), găng tay, giày golf chuyên dụng và trang phục phù hợp với quy định của sân.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Nghi thức trên sân golf": {
    message:
      "- **Tôn trọng người chơi khác:** Giữ im lặng khi người khác đang đánh bóng.\n- **Tốc độ chơi:** Duy trì tốc độ chơi phù hợp để không làm ảnh hưởng đến nhóm sau.\n- **Chăm sóc sân:** Cào lại các hố cát, sửa lại các vết bóng trên green.\n- **An toàn:** Luôn đảm bảo không ai đứng quá gần khi bạn vung gậy.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Kỹ thuật chơi golf": {
  ...
  "Kỹ thuật Swing là gì?": {
    message:
      "Swing là chuyển động xoay người để đánh bóng đi xa và chính xác. Đây là kỹ thuật nền tảng và quan trọng nhất trong golf. Một cú swing tốt đòi hỏi sự phối hợp nhịp nhàng của toàn bộ cơ thể từ tay, vai, hông đến chân.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Các loại cú đánh cơ bản trong golf?": {
    message:
      "- **Drive:** Cú phát bóng từ tee box, thường dùng gậy driver để đạt khoảng cách xa nhất.\n- **Approach:** Cú đánh tiếp cận green sau cú phát bóng.\n- **Chip:** Cú đánh ngắn, thấp và lăn nhiều khi bóng ở gần green.\n- **Putt:** Cú gạt bóng trên green để đưa bóng vào lỗ.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Cách cầm gậy golf?": {
    message:
      "Có ba kiểu cầm gậy chính:\n- **Overlapping Grip (Vardon Grip):** Ngón út của tay phải đè lên kẽ giữa ngón trỏ và ngón giữa của tay trái (đối với người thuận tay phải).\n- **Interlocking Grip:** Ngón út của tay phải và ngón trỏ của tay trái lồng vào nhau.\n- **Baseball Grip (Ten-Finger Grip):** Cầm gậy như cầm một cây gậy bóng chày, tất cả 10 ngón tay đều tiếp xúc với cán gậy.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Tư thế đứng đánh golf?": {
    message:
      "Một tư thế tốt cần đảm bảo sự cân bằng và ổn định. Hai chân mở rộng bằng vai, đầu gối hơi chùng, lưng giữ tương đối thẳng và nghiêng người về phía trước từ phần hông.",
    transition: { duration: 1000 },
    path: "TimHieuThem",
  },
  "Sân golf Việt Nam": {
  ...
  <>
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/sanphamkhac" element={<SanPhamKhac />} />
